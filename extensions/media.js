 ...
 * @instance
 */
WhatsApi.createRequestMediaUploadNode = function(filehash, filetype, filesize, filepath, to, caption, msgid, callback) {
	var attributes = {
		hash  : filehash,
		type  : filetype,
 ...
 * @instance
 */
WhatsApi.createMediaUploadNode = function(node, callback) {
 ...
 * @instance
 */
WhatsApi.getMediaFile = function(filepath, filetype, callback) {
 ...
 * @instance
 */
WhatsApi.downloadMediaFile = function(destUrl, callback) {
 ...
 * @instance
 */
WhatsApi.uploadMediaFile = function(queue, destUrl, callback) {
 ...
 * @instance
 */
WhatsApi.createImageThumbnail = function(srcPath, callback) {
 ...
 * @instance
 */
WhatsApi.createVideoThumbnail = function(srcPath, callback) {
